...
titers <- rename(titers, 'data/titer' = 'log2_hai_h3ny')
...
reg_df <- select(fv, -c('studysite', 'log2_hai_h3ny')) %>%
...
stan_rdump(list("N", "Nt", "Nsub", "y" , "w", "mask", "tvec", "tflu", "Kc", "Kt", "Kf", "Kw", "Xcov", "Xtreat", "Xflu", "Xbatch", "Xk", "obs", "mu_id"), 'fluvacs.data.R')
